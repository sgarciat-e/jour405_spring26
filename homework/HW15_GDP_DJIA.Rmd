...
```{r}
gdp_data |>
  ggplot(aes(x = GDP, y = DJIA, label = Quarter)) +
  geom_point() +
  labs(
    title = "Relationship Between GDP and DJIA",
    x = "GDP",
...
The scatter plot shows a strong positive relationship between the GDP and the DJIA, they are both increasing together. The higher correlations(0.9531058) further confirms the positive linear relationship between the variables.
