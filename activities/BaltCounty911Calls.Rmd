...
In the graph there's a stable average of 10 calls a day, with some of the highest spikes appearing in the spring to summertime tampering down in the fall and winter. However, there is also an unusual peak around October that stands out, it kind of indicates a pattern of occasional short term surges that a consistent increase over time. I would draw horizontal lines for the minimum, max, median and mean.
...
When unusual days are put into the context of z-scores instead of visual estimates, it is easier to see a pattern that extreme values occur throughout the year rather than spiking during certain seasons. All 11 unusually high days and 7 unusually low days are highlighted in this visual making it easier to spot out a pattern, this differs a lot from the other graph in terms of readability.
...
The most extreme day was October 4, 2022 (Tuesday). On that day there were 23 overdose-related 911 calls, far higher than a typical Tuesday with an average of 10 calls in Baltimore County. 
...
The data shows a steady number of overdose calls over the year, but several days saw spikes in call volume that in some cases doubled normal levels. The angle I would want to take is finding out what caused those spikes, What is different about these days and how do emergency services respond to high call days like this? What is happening in the area that makes this kind of spike so consistent throughout the year? Do holidays usually correspond with unussually high overdose calls? My next step would be to contact the county's health department and local hospitals.
