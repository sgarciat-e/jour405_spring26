...
The category that shows the biggest difference is the rarely/never voter category especially between weighted and un-weighted results that show a large drop in Yes votes after weighting.

2. How might these differences affect reporting on likely voter turnout?
The differences matter because weighting reduces the influence of small-turnout voters, it's biased naturally to report on people who actually to vote and exercise their civic duty.
...
I think that these differences exist because rarely/never voters are overepresented in the original raw sample. In this case small-turnout voters responded to the survey at higher rates and were overrepresented in the results
After weighting frequent voters were weighted up.
